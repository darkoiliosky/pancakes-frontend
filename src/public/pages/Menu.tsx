...
export default function Menu() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {/* Hero banner */}
      <div className="relative overflow-hidden rounded-2xl border border-amber-100 bg-gradient-to-r from-amber-50 to-amber-100 mb-6 shadow-sm">
        <div className="absolute inset-0 opacity-30" style={{ backgroundImage: "radial-gradient(circle at 20% 20%, #fbbf24 2px, transparent 2px), radial-gradient(circle at 60% 40%, #fde68a 2px, transparent 2px)", backgroundSize: "40px 40px, 50px 50px" }} />
        <div className="relative px-6 py-8 sm:px-10 sm:py-10">
          <h2 className="text-xl sm:text-2xl font-semibold text-amber-800">Freshly made, always delicious</h2>
          <p className="mt-1 text-sm text-amber-900/80 max-w-prose">Explore our selection of pancakes and treats. Choose your favorites and add them to your cart.</p>
        </div>
      </div>
